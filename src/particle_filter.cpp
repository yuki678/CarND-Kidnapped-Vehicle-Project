...
void ParticleFilter::updateWeights(double sensor_range, double std_landmark[], 
  ...
  for (i = 0; i < num_particles; i++) {
    ...
    // Filter map landmarks to keep only those which are in the sensor_range of current particle and push them to predictions vector
    ...
    // Associate observations to lpredicted andmarks using nearest neighbor algorithm
